...
def cfnn(sample_key):
    ...
    while hh_size <= hh_end:
        ...
        save_name = "./output/Temp/cfnn/coefficients_cfnn_"+str(sample_key)+"_"+str(hh_size)
    ...
    with np.load("./output/Temp/cfnn/coefficients_cfnn_"+str(sample_key)+"_"+str(hh_size)+'.npz') as data:
        w_1 = data['w_1']
        w_2 = data['w_2']
        b_1 = data['b_1']
        b_2 = data['b_2']
...
def cfnn_parallel(sample_key):
    ...
    np.savez("./output/NN/cfnn/pycoefficients_cfnn"+str(sample_key),
