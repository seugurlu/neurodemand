...
import pandas as pd
import os
os.environ['R_HOME'] = "/home/seugurlu/anaconda3/envs/pyneurodemand/lib/R"
...
if block1_comparison_test_costs:
    ...
    fig.set_xlabel( 'Mean Squared Errors on Test Sets')
...
if block9_cfnn_neg:
    ...
    fig = sns.violinplot(data = cost_frame, bw = 'silverman', inner = 'box', orient = 'h')
    sns.despine(left = True)
    fig.set_xlabel( r'Mean Squared Errors on Test Sets')
