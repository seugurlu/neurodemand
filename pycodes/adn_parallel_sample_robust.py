...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 11 18:01:03 2018
...
def adn(sample_key):
    ...
    while hh_size <= hh_end:
        ...
        save_name = "./output/Temp/robustness/sample_splitting/adn/adn"+str(sample_key)+"_"+str(hh_size)
    ...
    with np.load("./output/Temp/robustness/sample_splitting/adn/adn"+str(sample_key)+"_"+str(hh_size)+'.npz') as data:
        w_1 = data['w_1']
        w_2 = data['w_2']
        b_1 = data['b_1']
        b_2 = data['b_2']
...
def parallel_adn (sample_key):    
    train_accuracy, cv_accuracy, test_accuracy, w_1, w_2, b_1, b_2 = adn( sample_key )
    np.savez("./output/robustness/sample splitting/adn/adn"+str(sample_key),
...
#%%
Parallel(n_jobs = number_cores)(delayed(parallel_adn)(sample_key) for sample_key in sample_range)