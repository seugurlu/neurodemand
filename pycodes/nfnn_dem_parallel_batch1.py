...
def nfnn_dem(sample_key):
    ...
    main_sample = pd.HDFStore("./data/processed/main_sample")['main_sample']
    ...
    while hh_size <= hh_end:
        ...
        save_name = "./output/Temp/nfnn_dem/coefficients_nfnn_dem_"+str(sample_key)+"_"+str(hh_size)
    ...
    with np.load("./output/Temp/nfnn_dem/coefficients_nfnn_dem_"+str(sample_key)+"_"+str(hh_size)+'.npz') as data:
        w_1 = data['w_1']
        w_2 = data['w_2']
        b_1 = data['b_1']
        b_2 = data['b_2']
...
def parallel_nfnn_dem (sample_key):    
    train_accuracy, cv_accuracy, test_accuracy, w_1, w_2, b_1, b_2 = nfnn_dem( sample_key )
    np.savez("./output/NN/nfnn_dem/pycoefficients_nfnn_dem_"+str(sample_key),
...
#%%
Parallel(n_jobs = number_cores)(delayed(parallel_nfnn_dem)(sample_key+1) for sample_key in sample_range)