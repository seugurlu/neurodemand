...
def main(sample_key, x_train, y_train, x_cv, y_cv, x_test, y_test, tol_iter, number_goods):
    ...
    if cv == 1:
        ...
        while hh_size <= hh_end:
            ...
            save_name = os.getcwd()+"/output/Temp/nfnn/coefficients_nfnn_"+str(sample_key)+"_"+str(hh_size)
        ...
        with np.load(os.getcwd()+"/output/Temp/nfnn/coefficients_nfnn_"+str(sample_key)+"_"+str(hh_size)+'.npz') as data:
            w_1_out = data['w_1']
            w_2_out = data['w_2']
            b_1_out = data['b_1']
            b_2_out = data['b_2']
    ...
    np.savez(os.getcwd()+"/output/NN/nfnn/pycoefficients_nfnn_"+str(sample_key), w_1 = w_1_out, w_2 = w_2_out, b_1 = b_1_out, b_2 = b_2_out, 
