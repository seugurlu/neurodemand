...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 10:17:03 2017
...
def nfnn(sample_key):
    ...
    while hh_size <= hh_end:
        ...
        save_name = "./output/Temp/nfnn/coefficients_nfnn_robust"+str(sample_key)+"_"+str(hh_size)
    ...
    with np.load("./output/Temp/nfnn/coefficients_nfnn_robust"+str(sample_key)+"_"+str(hh_size)+'.npz') as data:
        w_1 = data['w_1']
        w_2 = data['w_2']
        b_1 = data['b_1']
        b_2 = data['b_2']
...
def parallel_nfnn (sample_key):    
    train_accuracy, cv_accuracy, test_accuracy, w_1, w_2, b_1, b_2 = nfnn( sample_key )
    np.savez("./output/NN/nfnn/robust/pycoefficients_nfnnrobust"+str(sample_key),
...
#%%
Parallel(n_jobs = number_cores)(delayed(parallel_nfnn)(sample_key+1) for sample_key in sample_range)