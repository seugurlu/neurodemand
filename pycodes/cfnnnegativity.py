...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 15:29:11 2017
...
def cfnn(sample_key):
   # session_conf = tf.ConfigProto(
    ...
    while hh_size <= hh_end:
        ...
        save_name = "./output/Temp/cfnn_neg/coefficients_cfnn_"+str(sample_key)+"_"+str(hh_size)
    ...
    with np.load("./output/Temp/cfnn_neg/coefficients_cfnn_"+str(sample_key)+"_"+str(hh_size)+'.npz') as data:
        w_1 = data['w_1']
        w_2 = data['w_2']
        b_1 = data['b_1']
        b_2 = data['b_2']
