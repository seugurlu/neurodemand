...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 18:05:16 2017
...
import quaids_estimation_viaR_dem as quaids
...
def parallel_aids (sample_key):    
    ...
    np.save(os.getcwd()+'/output/QUAIDS/Demographics/quaids_dem_'+str(sample_key+1), result)
    data.close()
